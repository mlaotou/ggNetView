create_layout_quadripartite_equal_gephi_layout <- function(
    graph_obj,
    r = 1,
    node_add = 7,
    anchor_dist = 10,
  ...
  # ---- 正方形的四个锚点 ----
  anchors <- list(
    c(-anchor_dist, -anchor_dist),  # lower-left
    c(-anchor_dist,  anchor_dist),  # upper-left
    c( anchor_dist,  anchor_dist),  # upper-right
    c( anchor_dist, -anchor_dist)   # lower-right
  )
