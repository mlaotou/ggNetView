...
## 6. Module composition heatmaps

`ggnetview_modularity_heatmaps()` visualises how module abundance
varies across samples. It takes the original OTU matrix and a graph
object, and produces a heatmap where rows are modules and columns are
samples.

```{r mod-heatmap, fig.width = 8, fig.height = 5, fig.cap = "Module abundance heatmap across samples."}
...
# 6. Module heatmap
ggnetview_modularity_heatmaps(mat, g, "Modularity")
```
